		...
		<!-- Header -->
			<div id="header" class="skel-panels-fixed">
				...
				<div class="top">
					...
					<!-- Logo -->
						<div id="logo">
							<span class="image avatar48"><img src="images/IPoly_logo.jpg" alt="" /></span>
							<h1 id="title">Senior Presentation Scheduler</h1>
							<span class="byline">Increasing entropy @iPoly</span>
						</div>
